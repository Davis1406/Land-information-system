...
$sid = mysqli_real_escape_string($conn,$_POST['sid']);
 ...
 echo '<script type="text/javascript">window.location="payments.php?act=1";</script>';
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Payments 
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Tittle Number</th><th>Plot Number</th><th>Location</th><th>DOI</th><th>Action</th></tr></thead><tbody></tbody></table>');
