...
$sid = (isset($_POST['clients']))?mysqli_real_escape_string($conn,$_POST['clients']):'';

 $sql = "select s.id,s.sname,s.balance,s.dot,s.fees,s.contact,b.location,s.joindate from clients as s,land as b where b.id=s.location and  s.delete_status='0' and s.id='".$sid."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{

$res = $q->fetch_assoc();
echo '  <form class="form-horizontal" id ="signupForm1" action="payments.php" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Tittle Number:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Plot Size:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Date Of Issue:</label>
    <div class="col-sm-10">
   ...
   <div class="form-group">
    <label class="control-label col-sm-2" for="email">Land Cost:</label>
    <div class="col-sm-10">
...
$sid = (isset($_POST['clients']))?mysqli_real_escape_string($conn,$_POST['clients']):'';
$sql = "select paid,submitdate,transcation_remark from payments  where stdid='".$sid."'";
$fq = $conn->query($sql);
if($fq->num_rows>0)
{


 $sql = "select s.id,s.sname,s.balance,s.fees,s.contact,b.location,s.joindate from clients as s,land as b where b.id=s.location  and s.id='".$sid."'";
$sq = $conn->query($sql);
$sr = $sq->fetch_assoc();
